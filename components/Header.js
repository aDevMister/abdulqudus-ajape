...
export default function Header() {
  return (
    <nav className="text-white px-4  pt-6">
      <div className="lg:container mx-auto lg:flex-row flex  flex-col gap-2 justify-between items-center">
        ...
        <div className="flex items-center z-[10] space-x-4">
          <Link href="https://instagram.com/devgorithm" className="cursor-pointer" target="_blank">
            <FaInstagram className="text-2xl hover:text-pink-500 transition-colors duration-300" />
          </Link>
          <Link href="https://x.com/devgorithm" className="cursor-pointer" target="_blank">
            <RiTwitterXLine className="text-2xl hover:text-blue-400 transition-colors duration-300" />
          </Link>
          <Link href="https://github.com/adevmister" className="cursor-pointer" target="_blank">
